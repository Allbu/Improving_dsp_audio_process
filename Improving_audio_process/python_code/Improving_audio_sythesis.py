...
def main():
    ...
    input_file_name = 'increase_dsp_audio_-main-master\wav_files\sample-16bits.wav'
    ...
    file_name = 'increase_dsp_audio_-main-master\wav_files\Albuquerque_audio_after_synthesis.wav'
